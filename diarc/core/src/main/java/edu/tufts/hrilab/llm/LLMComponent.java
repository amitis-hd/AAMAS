...
public class LLMComponent extends DiarcComponent {
  ...
  public String model = "o3-mini-2025-01-31";
  ...
  @TRADEService
  @Action
  public OpenaiResponses responses (String model, String input, String id) {
    return openai.createResponse(model, input, id);
  }
  ...
  **/
  ...
  public Completion visionCompletion(Prompt prompt) {
    ...
    byte[] image = null;
    try {
      imageSize = TRADE.getAvailableService(new TRADEServiceConstraints().name("getImageSize").argTypes())
          .call(Dimension.class);
